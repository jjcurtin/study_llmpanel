# Meeting with Colin on 2025-06-10

Need to

- Review conclusions from 6-3
- Review general system prompt and move toward finalizing
- Fine tune user prompts for each of the tones
- Consider user prompt for formality of tone
- Make decision on temperature



# From lab meeting on 2025-06-03
...
5.     Value Affirmation
6.     Norms
7.     We will consider a 7th tone category - "Just the facts"  for example some veterans do not want any excess wording for encouragement
